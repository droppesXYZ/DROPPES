...
export default function CalendarPage() {
  ...
  // Função para normalizar datas para comparação (remove horário) - CORRIGIDO para fuso local
  const normalizeDate = (dateString: string | Date) => {
    const date = new Date(dateString)
    // Usar horário local ao invés de UTC para evitar problemas de fuso horário
