...
// Endereço da carteira para pagamentos (Solana)
export const PAYMENT_WALLET_ADDRESS = process.env.PAYMENT_WALLET_ADDRESS || 'Dm5ThWMqJ6HgroFJuaw7EhWq9ZmctuDSf5DAuaPvfp73'
